...
function extendPrototypes() {
    Array.prototype.forEachPromise = function (asyncFn, callback) {
        ...
        return new Promise(function (resolve) {
            (function loop() {
                ...
                asyncFn(array[index], index++, function () { return loop(); });
            })();
        });
    };
    ...
    String.prototype.width = function (space, spaceFirst, spacingChar) {
        if (spaceFirst === void 0) { spaceFirst = false; }
        if (spacingChar === void 0) { spacingChar = " "; }
        ...
        if (spaceFirst)
            ...
            return this + Array(arrL).join(spacingChar);
    };
