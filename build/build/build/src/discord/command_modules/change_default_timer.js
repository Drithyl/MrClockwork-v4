...
function ChangeDefaultTimerCommand() {
    var changeDefaultTimerCommand = new Command(commandData);
    changeDefaultTimerCommand.addBehaviour(_behaviour);
    changeDefaultTimerCommand.addRequirements(commandPermissions.assertMemberIsTrusted, commandPermissions.assertCommandIsUsedInGameChannel);
...
function _behaviour(commandContext) {
    ...
    return Promise.resolve()
        ...
        .then(function () { return commandContext.respondToCommand("The default timer was changed. It may take a minute to update."); });
}
...
//# sourceMappingURL=change_default_timer.js.map