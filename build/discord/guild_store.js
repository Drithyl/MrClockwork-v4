...
exports.deployBotOnGuild = function (guildId) {
    ...
    return guildWrapper.findOrCreateRole(gameMasterRoleId, config.gameMasterRoleName, true, guildDataStore.getGameMasterRolePermissionOverwrites())
        ...
        .then(function () { return guildWrapper.findOrCreateChannel(newsChannelId, config.newsChannelName, [
        {
            id: guildId,
        ...
        .then(function () { return guildWrapper.findOrCreateChannel(helpChannelId, config.helpChannelName, [
        {
            id: guildId,
        ...
        .then(function () { return guildWrapper.findOrCreateCategory(recruitingCategoryId, config.recruitingCategoryName, [
        {
            id: guildId,
        ...
        .then(function () { return guildWrapper.findOrCreateCategory(blitzRecruitingCategoryId, config.blitzRecruitingCategoryName, [
        {
            id: guildId,
        ...
        .then(function () { return guildWrapper.findOrCreateCategory(gameCategoryId, config.gameCategoryName, [
        {
            id: guildId,
        ...
        .then(function () { return guildWrapper.findOrCreateCategory(blitzCategoryId, config.blitzCategoryName, [
        {
            id: guildId,
...
exports.updateHelpChannels = function (updatedHelpString, idOfGuildToUpdate) {
    if (idOfGuildToUpdate === void 0) { idOfGuildToUpdate = ""; }
