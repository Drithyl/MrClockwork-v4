...
module.exports.DRNvsDRN = function (atkMod, defMod) {
    if (atkMod === void 0) { atkMod = 0; }
    if (defMod === void 0) { defMod = 0; }
    drn1 = DRN();
    drn2 = DRN();
...
function roll(diceNum, max, explosive) {
    if (explosive === void 0) { explosive = false; }
