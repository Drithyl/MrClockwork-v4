...
function GuildWrapper(discordJsGuildObject)
{
  ...
  this.createGameChannel = (name) =>
  {
    return this.createChannel(name, null, this.getRecruitingCategory());
  };

  this.createGameRole = (name) =>
  {
    return this.createRole(name, true, null);
  };
