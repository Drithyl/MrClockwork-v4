...
function _behaviour(commandContext)
{
    ...
    .then(() => commandContext.respondToCommand(new MessagePayload(`The bot has been successfully deployed! You may rename or move around the roles, channels and categories created, but do not delete them! If one does get deleted, you can regenerate them by using this command again.`)));
}